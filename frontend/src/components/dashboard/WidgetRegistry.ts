...
const WIDGET_REGISTRY: WidgetDefinition[] = [
    ...
    // ── Manager-specific widgets (P1-1.1) ───────────────────────────
    {
        id: 'slaComplianceByPriority',
        titleKey: 'sla_compliance_by_priority',
        descriptionKey: 'sla_compliance_by_priority_desc',
        icon: 'Activity',
        minRole: 'manager',
        defaultVisible: true,
        minW: 2,
    ...
    {
        id: 'reliabilityMetrics',
        titleKey: 'reliability_metrics',
        descriptionKey: 'reliability_metrics_desc',
        icon: 'BarChart3',
        minRole: 'manager',
        defaultVisible: true,
        minW: 2,
    ...
    {
        id: 'costSummary',
        titleKey: 'cost_summary',
        descriptionKey: 'cost_summary_desc',
        icon: 'DollarSign',
        minRole: 'manager',
        defaultVisible: true,
        minW: 2,
    ...
    {
        id: 'technicianWorkload',
        titleKey: 'technician_workload',
        descriptionKey: 'technician_workload_desc',
        icon: 'Users',
        minRole: 'manager',
        defaultVisible: true,
        minW: 2,
    ...
    // ── Technician-specific widgets (P1-1.1) ────────────────────────
    {
        id: 'myWorkOrders',
        titleKey: 'my_work_orders',
        descriptionKey: 'my_work_orders_desc',
        icon: 'Wrench',
        minRole: 'technician',
        defaultVisible: true,
        minW: 2,
    ...
    {
        id: 'slaAlerts',
        titleKey: 'sla_alerts_short',
        descriptionKey: 'sla_alerts_desc',
        icon: 'AlertTriangle',
        minRole: 'technician',
        defaultVisible: true,
        minW: 1,
